...
Dyalog APL includes a data binding function (`2015⌶`[^1]) which supports data binding to APL arrays and namespaces.
...
[^1]: This function may remain as an I-beam or be replaced by one or more system functions in a future Version of Dyalog APL.
