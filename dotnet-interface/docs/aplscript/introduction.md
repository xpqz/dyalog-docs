...
If you choose to use the Dyalog APL IME it can be configured from the Dyalog *Configuration* dialog. You may change the associated `.DIN` file and various other options. See [Unicode Input Tab (Unicode Edition Only)](../../userguide/the-apl-environment/configuration-dialog.md).
