...
| Label | Parameter | Description |
| --- | --- | ---  |
| Width | [SM_Cols](../../configuration-parameters/sm-cols.md) | The width of the `⎕SM` and prefect windows. |
| Height | [SM_Rows](../../configuration-parameters/sm-rows.md) | The height of the `⎕SM` and prefect windows. |
