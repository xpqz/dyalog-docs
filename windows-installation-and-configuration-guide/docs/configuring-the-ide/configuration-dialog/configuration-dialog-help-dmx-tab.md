...
|---|---|---|
|DMX messages should go to|[DMXOutputOnError](../../configuration-parameters/dmxoutputonerror.md)|If checked, these boxes cause APL to display `⎕DMX` messages in the corresponding window(s).|
