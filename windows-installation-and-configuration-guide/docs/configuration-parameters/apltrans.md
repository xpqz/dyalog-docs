<h1 class="heading"><span class="name"> APLTrans</span></h1>
...
See also [Output table search path](../configuring-the-ide/configuration-dialog/configuration-dialog-output-tab-classic-edition-only.md).
