<h1 class="heading"><span class="name"> Log_Size</span></h1>
...
See also [Session log size](../configuring-the-ide/configuration-dialog/configuration-dialog-session-tab.md).
