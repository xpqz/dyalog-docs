<h1> InitialKeyboardLayoutShowAll</h1>
...
See also [Show keyboards for all Languages](../configuring-the-ide/configuration-dialog/configuration-dialog-unicode-input-tab-unicode-edition-only.md).
