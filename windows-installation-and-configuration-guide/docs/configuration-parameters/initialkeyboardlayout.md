<h1 class="heading"><span class="name"> InitialKeyboardLayout</span></h1>
...
See also [Keyboard](../configuring-the-ide/configuration-dialog/configuration-dialog-unicode-input-tab-unicode-edition-only.md).
