<h1 class="heading"><span class="name"> Default_WX</span></h1>
...
See also [Expose properties of GUI Namespaces](../configuring-the-ide/configuration-dialog/configuration-dialog-object-syntax-tab.md) and [⎕WX](../configuring-the-ide/configuration-dialog/configuration-dialog-session-tab.md).
