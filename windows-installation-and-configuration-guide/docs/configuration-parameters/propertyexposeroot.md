<h1 class="heading"><span class="name"> PropertyExposeRoot</span></h1>
...
See also [Expose properties of Root](../configuring-the-ide/configuration-dialog/configuration-dialog-object-syntax-tab.md).
