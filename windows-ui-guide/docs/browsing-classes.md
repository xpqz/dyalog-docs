...
![browsing classes 1](img/browsing-classes-1.png)
...
![browsing class scripts 1](img/browsing-class-scripts-1.png)

… and selecting `Parrot` in the left-hand pane brings up the Class Script for `Parrot`.

![browsing class scripts 2](img/browsing-class-scripts-2.png)

… and finally, selecting `Bird` in the left-hand pane brings up the Class Script for `Bird`.

![browsing class scripts 3](img/browsing-class-scripts-3.png)
...
![browsing class scripts 4](img/browsing-class-scripts-4.png)
