...
![object properties properties tab](img/object-properties-properties-tab.png)

## Value Tab

For a variable, the *Values* tab displays the value of the variable. For a function, it displays its canonical representation.

![object properties value tab](img/object-properties-value-tab.png)
...
![object properties monitor tab](img/object-properties-monitor-tab.png)
...
![object properties com properties tab](img/object-properties-com-properties-tab.png)
