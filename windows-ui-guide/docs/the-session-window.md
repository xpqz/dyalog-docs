...
![session window](img/session-window.png)
...
![session docking 1](img/session-docking-1.png)
...
![session docking 2](img/session-docking-2.png)
...
![session docking 3](img/session-docking-3.png)
...
![session docking 6](img/session-docking-6.png)
