<h1 class="heading"><span class="name">TabControl</span> <span class="command">Example 3</span></h1>
...
```
```apl
'F'⎕WC'Form' 'TabControl: FlatButtons Style'('Size' 25 50)
'F.TC'⎕WC'TabControl'('Style' 'FlatButtons')
