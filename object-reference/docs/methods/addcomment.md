...
Note that just before the comment is displayed, the [Grid](../objects/grid.md) generates a [ShowComment](../methodorevents/showcomment.md) event which gives you the opportunity to (temporarily) change the text and/or window size of a comment dynamically.
