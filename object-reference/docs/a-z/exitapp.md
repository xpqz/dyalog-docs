...
<h1 class="heading"><span class="name">ExitApp</span><span class="command">Event 132</span></h1>
...
Note that this event only provides for termination via the Windows Task List. See also the [ExitWindows](../methodorevents/exitwindows.md) event.
