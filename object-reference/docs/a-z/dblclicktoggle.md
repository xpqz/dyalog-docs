...
The DblClickToggle property specifies whether or not the user must single-click or double-click to toggle a child [CoolBand](../objects/coolband.md) between its maximised or minimised state.
