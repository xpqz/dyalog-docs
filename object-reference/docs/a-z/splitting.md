...
If enabled, this event is reported while a [Splitter](../objects/splitter.md) object is being dragged, between a [StartSplit](../methodorevents/startsplit.md) and an [EndSplit](../methodorevents/endsplit.md). This event is only reported if full-drag is enabled.
