...
<h1 class="heading"><span class="name">CustomFormat</span><span class="command">Property</span></h1>
...
**Note:** Non format characters that are not delimited by single quotes will result in unpredictable display by the [DateTimePicker](../objects/datetimepicker.md) object.
