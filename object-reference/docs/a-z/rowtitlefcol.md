...
<h1 class="heading"><span class="name">RowTitleFCol</span><span class="command">Property</span></h1>
...
The RowTitleFCol property specifies the colour of the row titles in a [Grid](../objects/grid.md) object
