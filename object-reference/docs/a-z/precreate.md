...
An ActiveXControl also generates a [Create](../methodorevents/create.md) event, which occurs *after* the PreCreate event at the point when the host application requires the instance to appear visually.
