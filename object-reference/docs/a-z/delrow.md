...
If the *Undo flag* is 1, the column may subsequently be restored by invoking the [Undo](../methodorevents/undo.md) method. If the *Undo flag* is omitted or is 0, the operation may not be undone.
