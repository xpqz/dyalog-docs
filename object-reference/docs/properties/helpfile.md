...
<h1 class="heading"><span class="name">HelpFile</span><span class="command">Property</span></h1>
...
For an [OCXClass](../objects/ocxclass.md) or[ OLEClient](../objects/oleclient.md) object, the HelpFile property is read-only.
