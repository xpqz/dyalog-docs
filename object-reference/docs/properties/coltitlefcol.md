...
<h1 class="heading"><span class="name">ColTitleFCol</span><span class="command">Property</span></h1>
...
The ColTitleFCol property specifies the colour of the column titles in a [Grid](../objects/grid.md) object
