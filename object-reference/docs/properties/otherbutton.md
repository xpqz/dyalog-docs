...
<h1 class="heading"><span class="name">OtherButton</span><span class="command">Property</span></h1>
...
The OtherButton property is Boolean and specifies whether or not the user can select a colour from a [ColorButton](../objects/colorbutton.md) object using the Windows colour selection dialog box.
