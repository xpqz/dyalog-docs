...
<h1 class="heading"><span class="name">RowTitleBCol</span><span class="command">Property</span></h1>
...
The RowTitleBCol property specifies the background colour of the row titles in a [Grid](../objects/grid.md) object
