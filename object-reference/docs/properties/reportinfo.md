...
<h1 class="heading"><span class="name">ReportInfo</span> <span class="command">Property</span></h1>
...
The ReportInfo property is a matrix that is displayed alongside each item in a [ListView](../objects/listview.md) object when its [View](view.md) property is `'Report'`. Each element of the matrix may be a character vector or a number.
