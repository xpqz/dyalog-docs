<h1 class="heading"><span class="name">ColTitleBCol</span> <span class="command">Property</span></h1>
...
The ColTitleBCol property specifies the background colour of the column titles in a [Grid](../objects/grid.md) object
