...
For a full description of elements [3-6], see [KeyPress](../methodorevents/keypress.md) event.


The 7<sup>th</sup> element of the event message contains either a reference to, or the name of the Input object associated with the current cell and on which the corresponding [KeyPress](../methodorevents/keypress.md) event has been reported.
