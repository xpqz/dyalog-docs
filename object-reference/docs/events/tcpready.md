...
<h1 class="heading"><span class="name">TCPReady</span> <span class="command">Event 379</span></h1>
...
This event is provided to enable you to control the transmission of a large amount of data that cannot be handled in a single call to [TCPSend](../methodorevents/tcpsend.md).
